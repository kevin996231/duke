...
public class DeadlineTest {
    ...
    public void testValidDate() {
        ...
        assertEquals("[D][X] 123 (by: Sat Sep 09 18:37:00 CST 19)", tester.getDescription(),
                "check description at the beginning");
        ...
        assertEquals("[D][V] 123 (by: Sat Sep 09 18:37:00 CST 19)", tester.getDescription(),
                "check description after task is done");
        assertEquals("D | V | 123 | Sat Sep 09 18:37:00 CST 19", tester.getProfile(),
                "check profile after task is done");
